    ...
    const logger = async (event) =>{
        ...
        fetch(config.apiURL+ "login" ,requestOptions).then(response=>{
            switch(response.status){
                case 400:
                    showMessage(true,"Faltan Parametros");
                    changeButtonState(button,true);
                    break;
        ...
        <div className="hold-transition login-page">
           <div className="login-box">
               ...
               <div className="card">
                   ...
                   <p className="login-box-msg">Autentíquese para iniciar sesión</p>
                   <form onSubmit={logger}>
                   <div className="input-group mb-3">
                       <input type="text" className="form-control"  id="username" name="username" placeholder="Apodo"/>
                   ...
                   <div className="input-group-mb-3">
                       <input type="password" className="form-control" id="pass" name="pass" placeholder="Clave"  />
                       <div  className="input-group-append">
                           <div>
